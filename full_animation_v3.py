...
#Change from v2. v2 introduced the idea that if a bus is full, it will leave. v2 is most realistic to the Duke Bus System.
#v3 introduces the notion that if there are no more people at the bus stop, it would be more efficient to leave than to wait for them.
